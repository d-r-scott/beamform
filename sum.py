...
def get_args():
	parser = ArgumentParser(description="Sums fine channel spectra together for a given FRB", formatter_class=ArgumentDefaultsHelpFormatter)

	parser.add_argument('--f_dir', type=str, help='Directory where the spectra files are stored')
